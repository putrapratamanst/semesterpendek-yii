...
$last_mahasiswa = Mahasiswa::model()->find(array('order'=>'id DESC'));
$last_mahasiswa_number = str_replace("INV:", "", $last_mahasiswa->mahasiswa_mumber);
$new_mahasiswa_number = $last_mahasiswa_number+1;

$model->mahasiswa_number = "INV:".$new_mahasiswa_number;
        ...
        }if($model->save());
{
        ...
        $model->user_id; // this is inserted item id
}
